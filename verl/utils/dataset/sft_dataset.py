...
class SFTDataset(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # string
        prompt_chat_str = tokenizer.apply_chat_template(prompt_chat, add_generation_prompt=True, tokenize=False, enable_thinking=getattr(tokenizer, 'enable_thinking', True))
