...
def hf_tokenizer(name_or_path, correct_pad_token=True, correct_gemma2=True, enable_thinking=True, **kwargs):
    ...
    Args:
        ...
        enable_thinking (bool): Whether to enable thinking mode for Qwen3 models.
    ...
    # Store enable_thinking as tokenizer attribute for use in apply_chat_template
