...
class TaskRunner:
    def run(self, config):
        ...
        enable_thinking = config.actor_rollout_ref.model.get("enable_thinking", True)
        tokenizer = hf_tokenizer(local_path, trust_remote_code=trust_remote_code, enable_thinking=enable_thinking)
