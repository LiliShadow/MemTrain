...
# Data paths
WORKING_DIR=${PWD}
DATA_DIR=${WORKING_DIR}/taskutils/memory_data/nq_hotpotqa_train_multi_2
BASE_MODEL=Qwen2.5-7B-Instruct
MODEL_PATH="checkpoints/memtrain/$BASE_MODEL/global_step_300/huggingface"
PROJECT=MEM1
EXPERIMENT_NAME=memtrain_350_then_mem1/$BASE_MODEL
CKPT_DIR=checkpoints/$PROJECT/$EXPERIMENT_NAME
