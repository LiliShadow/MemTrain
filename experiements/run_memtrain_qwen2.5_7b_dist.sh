...
TRAIN_PATH="${DATASET_ROOT}/mask_pretrain_150docs_top30.parquet"
EXP=memtrain/${MODEL_PATH##*/}
PROJ_DIR=${PROJ_ROOT}/${EXP}
CKPT_DIR=checkpoints/$EXP
ROLLOUT_DATA_DIR=./rollouts/$EXP
...
ray job submit --runtime-env-json="${RUNTIME_ENV_JSON}" \
    ...
    algorithm.enable_memory_recall=True \
    algorithm.memory_recall_n=8 \
