...
async def async_query_llm(item, model, tokenizer, temperature=0.7, top_p=0.95, stop=None, save_trajectory=False):
    idx = item["_id"]
    ...
    for chunk_idx, i in enumerate(range(0, len(input_ids), RECURRENT_CHUNK_SIZE)):
