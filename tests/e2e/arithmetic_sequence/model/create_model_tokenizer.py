...
print(load_tokenizer.apply_chat_template(chat, tokenize=True, add_generation_prompt=True, max_length=10, padding="max_length", enable_thinking=getattr(load_tokenizer, 'enable_thinking', True)))
